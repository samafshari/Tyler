...
namespace Tyler.ViewModels
{
    public class TileDefsEditorViewModel : ViewModel
    {
        ...
        public TileDefsEditorViewModel() { }
        ...
        {
            get => SpriteSheet.Sprites.Contains(_selectedSprite) ? _selectedSprite : null;
        ...
        {
            get => World.TileDefs.Contains(_selectedTileDef) ? _selectedTileDef : null;
